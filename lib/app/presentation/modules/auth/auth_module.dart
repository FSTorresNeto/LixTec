...
import 'package:lixtec/app/presentation/modules/auth/pages/load_page.dart';
...
import 'package:lixtec/app/presentation/modules/auth/pages/terms.dart';

class AuthModule extends Module {
  @override
  final List<Bind> binds = [
    Bind<AuthState>((i) => AuthState(i.get(), i.get(), i.get(), i.get())),
  ...
  final List<ModularRoute> routes = [
    ChildRoute('/', child: (_, args) => const LoadPage()),
